...
class BillingApi
{
     ...
     * @return \SimplySDK\Model\GetInvoices200Response
     */
     ...
     * @throws \SimplySDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SimplySDK\Model\GetInvoices200Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SimplySDK\Model\GetInvoices200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\SimplySDK\Model\GetInvoices200Response';
        $request = $this->getInvoicesRequest($contentType);
