# SimplyCom\DnszoneApi

All URIs are relative to https://api.simply.com, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**addDnsRecord()**](DnszoneApi.md#addDnsRecord) | **POST** /2/my/products/{object}/dns/records/ | Add new DNS record to a product DNS zone |
| [**ddnsHelper()**](DnszoneApi.md#ddnsHelper) | **GET** /2/ddns/ | Dynamic DNS helper endpoint |
| [**deleteDnsRecord()**](DnszoneApi.md#deleteDnsRecord) | **DELETE** /2/my/products/{object}/dns/records/{record_id}/ | Remove DNS record from a product DNS zone |
| [**dyndns()**](DnszoneApi.md#dyndns) | **GET** /2/dyndns/ | DynDNS protocol-compatible endpoint |
| [**getDnsRecords()**](DnszoneApi.md#getDnsRecords) | **GET** /2/my/products/{object}/dns/records/ | Retrieve all DNS records for a product |
| [**getDnsZone()**](DnszoneApi.md#getDnsZone) | **GET** /2/my/products/{object}/dns/ | Retrieve DNS zone metadata |
| [**reloadDnsZone()**](DnszoneApi.md#reloadDnsZone) | **POST** /2/my/products/{object}/dns/reload/ | Force-reload a DNS zone |
| [**updateDnsRecord()**](DnszoneApi.md#updateDnsRecord) | **PUT** /2/my/products/{object}/dns/records/{record_id}/ | Update a DNS record in a product DNS zone |
...
$apiInstance = new SimplyCom\Api\DnszoneApi(
...
try {
    ...
    echo 'Exception when calling DnszoneApi->addDnsRecord: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DnszoneApi->ddnsHelper: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DnszoneApi->deleteDnsRecord: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DnszoneApi->dyndns: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DnszoneApi->getDnsRecords: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DnszoneApi->getDnsZone: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DnszoneApi->reloadDnsZone: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DnszoneApi->updateDnsRecord: ', $e->getMessage(), PHP_EOL;
}
```
