...
class OrderApi
{
     ...
     * @return \SimplyCom\SimplyCom\Model\OrderDnsService200Response|\SimplyCom\SimplyCom\Model\OrderDnsService400Response|null
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SimplyCom\SimplyCom\Model\OrderDnsService200Response|\SimplyCom\SimplyCom\Model\OrderDnsService400Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    return $this->handleResponseWithDataType(
                        '\SimplyCom\SimplyCom\Model\OrderDnsService400Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        return $this->orderDnsServiceAsyncWithHttpInfo($orderDnsServicePayload, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $returnType = '\SimplyCom\SimplyCom\Model\OrderDnsService200Response';
        $request = $this->orderDnsServiceRequest($orderDnsServicePayload, $contentType);
    ...
    ): Request
    {
        ...
        if ($orderDnsServicePayload === null || (is_array($orderDnsServicePayload) && count($orderDnsServicePayload) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $orderDnsServicePayload when calling orderDnsService'
            );
        }
        ...
        // for model (json/xml)
        if (isset($orderDnsServicePayload)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($orderDnsServicePayload));
            } else {
                $httpBody = $orderDnsServicePayload;
            }
