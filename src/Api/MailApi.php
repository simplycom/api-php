...
class MailApi
{
    ...
    {
        return $this->addMailAccountAsyncWithHttpInfo($object, $addMailAccountPayload, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($addMailAccountPayload === null || (is_array($addMailAccountPayload) && count($addMailAccountPayload) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $addMailAccountPayload when calling addMailAccount'
            );
        }
        ...
        // for model (json/xml)
        if (isset($addMailAccountPayload)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($addMailAccountPayload), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
                $httpBody = $addMailAccountPayload;
            }
     ...
     *
     * List mail accounts for a product
     *
     * @param  string $object The product handle/UUID, as found in the /my/products/ endpoint. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMailAccounts'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SimplyCom\Model\GetMailAccounts200Response
     */
    public function getMailAccounts(
        string $object,
        string $contentType = self::contentTypes['getMailAccounts'][0]
    ): \SimplyCom\Model\GetMailAccounts200Response
    {
        list($response) = $this->getMailAccountsWithHttpInfo($object, $contentType);
        return $response;
    }

    /**
     * Operation getMailAccountsWithHttpInfo
     *
     * List mail accounts for a product
     *
     * @param  string $object The product handle/UUID, as found in the /my/products/ endpoint. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \SimplyCom\Model\GetMailAccounts200Response, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    public function getMailAccountsWithHttpInfo(
        string $object,
        string $contentType = self::contentTypes['getMailAccounts'][0]
    ): array
    {
        $request = $this->getMailAccountsRequest($object, $contentType);
    ...
    /**
     * Operation getMailAccountsAsync
     *
     * List mail accounts for a product
     *
     * @param  string $object The product handle/UUID, as found in the /my/products/ endpoint. (required)
     ...
     * @return PromiseInterface
     */
    public function getMailAccountsAsync(
        string $object,
        string $contentType = self::contentTypes['getMailAccounts'][0]
    ): PromiseInterface
    {
        return $this->getMailAccountsAsyncWithHttpInfo($object, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMailAccountsAsyncWithHttpInfo
     *
     * List mail accounts for a product
     *
     * @param  string $object The product handle/UUID, as found in the /my/products/ endpoint. (required)
     ...
     * @return PromiseInterface
     */
    public function getMailAccountsAsyncWithHttpInfo(
        string $object,
        string $contentType = self::contentTypes['getMailAccounts'][0]
    ): PromiseInterface
    {
        $returnType = '\SimplyCom\Model\GetMailAccounts200Response';
        $request = $this->getMailAccountsRequest($object, $contentType);
    ...
    /**
     * Create request for operation 'getMailAccounts'
     *
     * @param  string $object The product handle/UUID, as found in the /my/products/ endpoint. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMailAccounts'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMailAccountsRequest(
        string $object,
        string $contentType = self::contentTypes['getMailAccounts'][0]
    ): Request
    {
        ...
        if ($object === null || (is_array($object) && count($object) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $object when calling getMailAccounts'
            );
        }
