...
class MailApi
{
     ...
     * @param  \SimplyCom\SimplyCom\Model\AddMailAccountRequest $addMailAccountRequest addMailAccountRequest (required)
     ...
     * @return \SimplyCom\SimplyCom\Model\UpdateDnsRecord200Response|\SimplyCom\SimplyCom\Model\AddMailAccount400Response|null
     */
     ...
     *
     * @param  string $object The product handle/UUID, as found in the /my/products/ endpoint. (required)
     * @param  \SimplyCom\SimplyCom\Model\AddMailAccountRequest $addMailAccountRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addMailAccount'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SimplyCom\SimplyCom\Model\UpdateDnsRecord200Response|\SimplyCom\SimplyCom\Model\AddMailAccount400Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    return $this->handleResponseWithDataType(
                        '\SimplyCom\SimplyCom\Model\AddMailAccount400Response',
                        $request,
                        $response,
                    );
            }
    ...
    ): Request
    {
        ...
        // verify the required parameter 'addMailAccountRequest' is set
        if ($addMailAccountRequest === null || (is_array($addMailAccountRequest) && count($addMailAccountRequest) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $addMailAccountRequest when calling addMailAccount'
            );
        }
