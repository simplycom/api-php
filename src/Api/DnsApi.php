...
class DnsApi
{
     ...
     * @param  \SimplyCom\SimplyCom\Model\AddDnsRecordRequest $addDnsRecordRequest addDnsRecordRequest (required)
     ...
     * @return \SimplyCom\SimplyCom\Model\AddDnsRecord200Response|\SimplyCom\SimplyCom\Model\AddDnsRecord400Response|null
     */
     ...
     *
     * @param  string $object The product handle/UUID, as found in the /my/products/ endpoint. (required)
     * @param  \SimplyCom\SimplyCom\Model\AddDnsRecordRequest $addDnsRecordRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addDnsRecord'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SimplyCom\SimplyCom\Model\AddDnsRecord200Response|\SimplyCom\SimplyCom\Model\AddDnsRecord400Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $request = $this->addDnsRecordRequest($object, $addDnsRecordRequest, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    return $this->handleResponseWithDataType(
                        '\SimplyCom\SimplyCom\Model\AddDnsRecord400Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        return $this->addDnsRecordAsyncWithHttpInfo($object, $addDnsRecordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $returnType = '\SimplyCom\SimplyCom\Model\AddDnsRecord200Response';
        $request = $this->addDnsRecordRequest($object, $addDnsRecordRequest, $contentType);
    ...
    ): Request
    {
        ...
        // verify the required parameter 'addDnsRecordRequest' is set
        if ($addDnsRecordRequest === null || (is_array($addDnsRecordRequest) && count($addDnsRecordRequest) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $addDnsRecordRequest when calling addDnsRecord'
            );
        }
        ...
        // for model (json/xml)
        if (isset($addDnsRecordRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($addDnsRecordRequest));
            } else {
                $httpBody = $addDnsRecordRequest;
            }
     ...
     * @param  string|null $record The name of the DNS record you wish to create/update on the domain. Overrides data inferred from hostname parameter. (optional)
     ...
     * @param  int|null $ttl The TTL (Time To Live) of the generated DNS record in seconds. Defaults to 3600. (optional, default to 3600)
     ...
     * @return PromiseInterface
     */
    public function ddnsHelperAsync(
        string $hostname,
        ?string $domain = null,
        ?string $record = null,
        ?string $myip = null,
     ...
     * @return PromiseInterface
     */
    public function ddnsHelperAsyncWithHttpInfo(
        string $hostname,
        ?string $domain = null,
        ?string $record = null,
        ?string $myip = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ddnsHelperRequest(
        string $hostname,
        ?string $domain = null,
        ?string $record = null,
        ?string $myip = null,
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SimplyCom\SimplyCom\Model\UpdateDnsRecord200Response|null
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SimplyCom\SimplyCom\Model\UpdateDnsRecord200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        return $this->deleteDnsRecordAsyncWithHttpInfo($object, $recordId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $returnType = '\SimplyCom\SimplyCom\Model\UpdateDnsRecord200Response';
        $request = $this->deleteDnsRecordRequest($object, $recordId, $contentType);
     ...
     * @return PromiseInterface
     */
    public function dyndnsAsyncWithHttpInfo(
        string $hostname,
        ?string $myip = null,
        ?string $domain = null,
        string $contentType = self::contentTypes['dyndns'][0]
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SimplyCom\SimplyCom\Model\GetDnsRecords200Response|\SimplyCom\SimplyCom\Model\GetDnsRecords404Response|null
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SimplyCom\SimplyCom\Model\GetDnsZone200Response|null
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SimplyCom\SimplyCom\Model\GetDnsZone200Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return PromiseInterface
     */
    public function getDnsZoneAsyncWithHttpInfo(
        string $object,
        string $contentType = self::contentTypes['getDnsZone'][0]
    ): PromiseInterface
    {
        $returnType = '\SimplyCom\SimplyCom\Model\GetDnsZone200Response';
        $request = $this->getDnsZoneRequest($object, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDnsZoneRequest(
        string $object,
        string $contentType = self::contentTypes['getDnsZone'][0]
    ): Request
    {
     ...
     * @return PromiseInterface
     */
    public function reloadDnsZoneAsync(
        string $object,
        string $contentType = self::contentTypes['reloadDnsZone'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function reloadDnsZoneAsyncWithHttpInfo(
        string $object,
        string $contentType = self::contentTypes['reloadDnsZone'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function reloadDnsZoneRequest(
        string $object,
        string $contentType = self::contentTypes['reloadDnsZone'][0]
    ): Request
    {
     ...
     * @param  string $object The product handle/UUID, as found in the /my/products/ endpoint. (required)
     * @param  int $recordId The id of a DNS record in a DNS zone. (required)
     * @param  \SimplyCom\SimplyCom\Model\UpdateDnsRecordRequest $updateDnsRecordRequest updateDnsRecordRequest (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SimplyCom\SimplyCom\Model\UpdateDnsRecord200Response|\SimplyCom\SimplyCom\Model\AddDnsRecord400Response|null
     */
     ...
     * @param  string $object The product handle/UUID, as found in the /my/products/ endpoint. (required)
     * @param  int $recordId The id of a DNS record in a DNS zone. (required)
     * @param  \SimplyCom\SimplyCom\Model\UpdateDnsRecordRequest $updateDnsRecordRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateDnsRecord'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SimplyCom\SimplyCom\Model\UpdateDnsRecord200Response|\SimplyCom\SimplyCom\Model\AddDnsRecord400Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $request = $this->updateDnsRecordRequest($object, $recordId, $updateDnsRecordRequest, $contentType);
    ...
    {
        return $this->updateDnsRecordAsyncWithHttpInfo($object, $recordId, $updateDnsRecordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        // verify the required parameter 'updateDnsRecordRequest' is set
        if ($updateDnsRecordRequest === null || (is_array($updateDnsRecordRequest) && count($updateDnsRecordRequest) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $updateDnsRecordRequest when calling updateDnsRecord'
            );
        }
        ...
        // for model (json/xml)
        if (isset($updateDnsRecordRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($updateDnsRecordRequest));
            } else {
                $httpBody = $updateDnsRecordRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
