...
class DnsApi
{
    ...
    {
        return $this->addDnsRecordAsyncWithHttpInfo($object, $dnsRecordPayload, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($dnsRecordPayload === null || (is_array($dnsRecordPayload) && count($dnsRecordPayload) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $dnsRecordPayload when calling addDnsRecord'
            );
        }
        ...
        // for model (json/xml)
        if (isset($dnsRecordPayload)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($dnsRecordPayload));
            } else {
                $httpBody = $dnsRecordPayload;
            }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SimplyCom\SimplyCom\Model\SuccessResponse|\SimplyCom\SimplyCom\Model\AddDnsRecord400Response|null
     */
    ...
    ): \SimplyCom\SimplyCom\Model\SuccessResponse|\SimplyCom\SimplyCom\Model\AddDnsRecord400Response|null
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SimplyCom\SimplyCom\Model\SuccessResponse|\SimplyCom\SimplyCom\Model\AddDnsRecord400Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        return $this->updateDnsRecordAsyncWithHttpInfo($object, $recordId, $dnsRecordPayload, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($dnsRecordPayload === null || (is_array($dnsRecordPayload) && count($dnsRecordPayload) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $dnsRecordPayload when calling updateDnsRecord'
            );
        }
