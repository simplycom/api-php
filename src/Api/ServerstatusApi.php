...
class ServerstatusApi
{
     ...
     * @return \SimplyCom\Model\GetServerStatusMessages200Response
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \SimplyCom\Model\GetServerStatusMessages200Response, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
