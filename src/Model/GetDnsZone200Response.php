...
class GetDnsZone200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'status' => 'int',
        'message' => 'string',
        'zone' => '\SimplyCom\SimplyCom\Model\GetDnsZone200ResponseZone'
    ];
     ...
     * Gets zone
     *
     * @return \SimplyCom\SimplyCom\Model\GetDnsZone200ResponseZone|null
     */
    public function getZone(): ?\SimplyCom\SimplyCom\Model\GetDnsZone200ResponseZone
    {
     ...
     * Sets zone
     *
     * @param \SimplyCom\SimplyCom\Model\GetDnsZone200ResponseZone|null $zone zone
     *
     * @return $this
     */
    public function setZone(?\SimplyCom\SimplyCom\Model\GetDnsZone200ResponseZone $zone): static
    {
        if (is_null($zone)) {
