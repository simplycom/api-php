...
/**
 * AddMailAccountPayload Class Doc Comment
 *
 * @package  SimplyCom
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AddMailAccountPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AddMailAccountPayload';
     ...
     * Sets localpart
     *
     * @param string $localpart The local part of the email address (before @). Must be unique for the domain.
     *
     * @return $this
     */
