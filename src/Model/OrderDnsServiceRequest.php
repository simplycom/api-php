...
class OrderDnsServiceRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets domain
     *
     * @param string $domain Fully qualified domain name (e.g., example.com). Both ASCII and IDN domains are supported.
     *
     * @return $this
     */
     ...
     * Sets authid
     *
     * @param string|null $authid Authorization code for domain transfer (required for transfer and transferonly actions)
     *
     * @return $this
     */
