...
class AddDnsRecord200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'status' => 'int',
        'message' => 'string',
        'record' => '\SimplyCom\SimplyCom\Model\AddDnsRecord200ResponseRecord'
    ];
    ...
    */
     ...
     * Gets record
     *
     * @return \SimplyCom\SimplyCom\Model\AddDnsRecord200ResponseRecord|null
     */
    public function getRecord(): ?\SimplyCom\SimplyCom\Model\AddDnsRecord200ResponseRecord
    {
     ...
     * Sets record
     *
     * @param \SimplyCom\SimplyCom\Model\AddDnsRecord200ResponseRecord|null $record record
     *
     * @return $this
     */
    public function setRecord(?\SimplyCom\SimplyCom\Model\AddDnsRecord200ResponseRecord $record): static
    {
        if (is_null($record)) {
