...
class OrderDnsService200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'status' => 'int',
        'message' => 'string',
        'order' => '\SimplyCom\SimplyCom\Model\OrderDnsService200ResponseOrder'
    ];
     ...
     * Gets order
     *
     * @return \SimplyCom\SimplyCom\Model\OrderDnsService200ResponseOrder|null
     */
    public function getOrder(): ?\SimplyCom\SimplyCom\Model\OrderDnsService200ResponseOrder
    {
     ...
     * Sets order
     *
     * @param \SimplyCom\SimplyCom\Model\OrderDnsService200ResponseOrder|null $order order
     *
     * @return $this
     */
    public function setOrder(?\SimplyCom\SimplyCom\Model\OrderDnsService200ResponseOrder $order): static
    {
        if (is_null($order)) {
