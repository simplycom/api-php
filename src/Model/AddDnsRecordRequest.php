...
class AddDnsRecordRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets type
     *
     * @param string $type DNS record type (A, AAAA, CNAME, MX, TXT, SRV, etc.)
     *
     * @return $this
     */
     ...
     * Sets priority
     *
     * @param int|null $priority Priority value (required for MX and SRV records)
     *
     * @return $this
     */
     ...
     * Sets ttl
     *
     * @param int|null $ttl Time To Live in seconds. Defaults to zone default if not specified.
     *
     * @return $this
     */
