...
class DnsApi
{
     ...
     * @param  \SimplyCom\Sdk\Model\AddDnsRecordRequest|null $addDnsRecordRequest addDnsRecordRequest (optional)
     ...
     *
     * @throws \SimplyCom\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SimplyCom\Sdk\Model\AddDnsRecord200Response
     */
    public function addDnsRecord($object, $addDnsRecordRequest = null, string $contentType = self::contentTypes['addDnsRecord'][0])
    {
     ...
     *
     * @param  string $object The product handle/UUID, as found in the /my/products/ endpoint. (required)
     * @param  \SimplyCom\Sdk\Model\AddDnsRecordRequest|null $addDnsRecordRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addDnsRecord'] to see the possible values for this operation
     *
     * @throws \SimplyCom\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SimplyCom\Sdk\Model\AddDnsRecord200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function addDnsRecordWithHttpInfo($object, $addDnsRecordRequest = null, string $contentType = self::contentTypes['addDnsRecord'][0])
    {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SimplyCom\Sdk\Model\AddDnsRecord200Response',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function addDnsRecordAsync($object, $addDnsRecordRequest = null, string $contentType = self::contentTypes['addDnsRecord'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addDnsRecordAsyncWithHttpInfo($object, $addDnsRecordRequest = null, string $contentType = self::contentTypes['addDnsRecord'][0])
    {
        $returnType = '\SimplyCom\Sdk\Model\AddDnsRecord200Response';
        $request = $this->addDnsRecordRequest($object, $addDnsRecordRequest, $contentType);
     ...
     */
    public function addDnsRecordRequest($object, $addDnsRecordRequest = null, string $contentType = self::contentTypes['addDnsRecord'][0])
    {
     ...
     * @throws \SimplyCom\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SimplyCom\Sdk\Model\DeleteDnsRecord200Response
     */
    public function deleteDnsRecord($object, $recordId, string $contentType = self::contentTypes['deleteDnsRecord'][0])
    {
     ...
     * @throws \SimplyCom\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SimplyCom\Sdk\Model\DeleteDnsRecord200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteDnsRecordWithHttpInfo($object, $recordId, string $contentType = self::contentTypes['deleteDnsRecord'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SimplyCom\Sdk\Model\DeleteDnsRecord200Response',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDnsRecordAsync($object, $recordId, string $contentType = self::contentTypes['deleteDnsRecord'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDnsRecordAsyncWithHttpInfo($object, $recordId, string $contentType = self::contentTypes['deleteDnsRecord'][0])
    {
        $returnType = '\SimplyCom\Sdk\Model\DeleteDnsRecord200Response';
        $request = $this->deleteDnsRecordRequest($object, $recordId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteDnsRecordRequest($object, $recordId, string $contentType = self::contentTypes['deleteDnsRecord'][0])
    {
     ...
     * @return object
     */
    public function updateDnsRecord($object, $recordId, $addDnsRecordRequest = null, string $contentType = self::contentTypes['updateDnsRecord'][0])
    {
        list($response) = $this->updateDnsRecordWithHttpInfo($object, $recordId, $addDnsRecordRequest, $contentType);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDnsRecordWithHttpInfo($object, $recordId, $addDnsRecordRequest = null, string $contentType = self::contentTypes['updateDnsRecord'][0])
    {
        $request = $this->updateDnsRecordRequest($object, $recordId, $addDnsRecordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDnsRecordAsync($object, $recordId, $addDnsRecordRequest = null, string $contentType = self::contentTypes['updateDnsRecord'][0])
    {
        return $this->updateDnsRecordAsyncWithHttpInfo($object, $recordId, $addDnsRecordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDnsRecordAsyncWithHttpInfo($object, $recordId, $addDnsRecordRequest = null, string $contentType = self::contentTypes['updateDnsRecord'][0])
    {
        $returnType = 'object';
        $request = $this->updateDnsRecordRequest($object, $recordId, $addDnsRecordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateDnsRecordRequest($object, $recordId, $addDnsRecordRequest = null, string $contentType = self::contentTypes['updateDnsRecord'][0])
    {
