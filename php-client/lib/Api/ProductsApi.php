...
class ProductsApi
{
     ...
     * @return \SimplySDK\Model\GetProductList200Response
     */
    public function getProductList(string $contentType = self::contentTypes['getProductList'][0])
    {
     ...
     * @throws \SimplySDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SimplySDK\Model\GetProductList200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductListWithHttpInfo(string $contentType = self::contentTypes['getProductList'][0])
    {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SimplySDK\Model\GetProductList200Response',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function getProductListAsync(string $contentType = self::contentTypes['getProductList'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductListAsyncWithHttpInfo(string $contentType = self::contentTypes['getProductList'][0])
    {
        $returnType = '\SimplySDK\Model\GetProductList200Response';
        $request = $this->getProductListRequest($contentType);
     ...
     */
    public function getProductListRequest(string $contentType = self::contentTypes['getProductList'][0])
    {


        $resourcePath = '/my/products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
