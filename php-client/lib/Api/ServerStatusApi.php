...
class ServerStatusApi
{
     ...
     * @return \SimplySDK\Model\GetServerStatusMessages200Response
     */
    public function getServerStatusMessages(string $contentType = self::contentTypes['getServerStatusMessages'][0])
    {
     ...
     * @throws \SimplySDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SimplySDK\Model\GetServerStatusMessages200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServerStatusMessagesWithHttpInfo(string $contentType = self::contentTypes['getServerStatusMessages'][0])
    {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SimplySDK\Model\GetServerStatusMessages200Response',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function getServerStatusMessagesAsync(string $contentType = self::contentTypes['getServerStatusMessages'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServerStatusMessagesAsyncWithHttpInfo(string $contentType = self::contentTypes['getServerStatusMessages'][0])
    {
        $returnType = '\SimplySDK\Model\GetServerStatusMessages200Response';
        $request = $this->getServerStatusMessagesRequest($contentType);
     ...
     */
    public function getServerStatusMessagesRequest(string $contentType = self::contentTypes['getServerStatusMessages'][0])
    {
